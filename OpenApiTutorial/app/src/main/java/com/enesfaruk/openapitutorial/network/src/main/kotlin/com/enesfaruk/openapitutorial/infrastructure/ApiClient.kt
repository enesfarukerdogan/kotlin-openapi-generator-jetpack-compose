package com.enesfaruk.openapitutorial.infrastructure
...
class ApiClient(
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey = "com.enesfaruk.openapitutorial.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "https://jsonplaceholder.typicode.com")
        }
    }
}
